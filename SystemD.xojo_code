...
Protected Module SystemD
	#tag Method, Flags = &h1
		Protected Sub Initialize()
		  ...
		  // Tell the system that the app has launched properly
		  send(states.Ready)
		End Sub
	#tag EndMethod
		    ...
		    If SystemDIsInstalled Then
		      ...
		      If System.IsFunctionAvailable("sd_notify", "libsystemd.so") Then
		        ...
		        Case States.Stopping
		          // Tell SystemD that we're stopping
		          msg = "STOPPING"
		          
		        Case States.Status
		          // Send our current status to SystemD
		          msg = "STATUS"
		          
		        Case States.MainPID
		          // If the system asks for our process ID, return it
	...
	#tag Method, Flags = &h21
		Private Function SystemDIsInstalled() As Boolean
